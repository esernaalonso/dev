...
#define SBK_QTNETWORK_QPAIR_QHOSTADDRESS_INT_IDX                     2 // const QPair<QHostAddress, int > &
#define SBK_QTNETWORK_QHASH_QNETWORKREQUEST_ATTRIBUTE_QVARIANT_IDX   3 // QHash<QNetworkRequest::Attribute, QVariant >
#define SBK_QTNETWORK_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX                4 // QPair<QByteArray, QByteArray >
#define SBK_QTNETWORK_QLIST_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX          5 // QList<QPair<QByteArray, QByteArray > >
#define SBK_QTNETWORK_QLIST_QNETWORKCONFIGURATION_IDX                6 // QList<QNetworkConfiguration >
#define SBK_QTNETWORK_QLIST_QNETWORKADDRESSENTRY_IDX                 7 // QList<QNetworkAddressEntry >
#define SBK_QTNETWORK_QLIST_QHOSTADDRESS_IDX                         8 // QList<QHostAddress >
#define SBK_QTNETWORK_QLIST_QNETWORKINTERFACE_IDX                    9 // QList<QNetworkInterface >
